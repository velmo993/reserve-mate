...
function display_daterange_booking_form($property_id, $property_ids, $property_count, $property) {
    error_log("property count: $property_count");
    ob_start();
    ?>
    ...
    <form id="rm-booking-form" class="date-range-form" method="post">
        ...
        <div class="flatpickr-calendar-container booking-form-content">
            ...
            <div class="">
                <div id="date-range" class="flatpick-r-daterange"></div> <!-- FlatPicker js calendar comes here -->
            </div>
        </div>
        <div class="form-inputs booking-form-content">
            ...
            <div class="form-field request-field">
                <label for="client_request">Requests:</label>
                <textarea placeholder="If you have any requests." name="client_request" id="client_request" maxlength="500"></textarea>
            </div>
        ...
        <?php if($property_id) : ?>
        <?php error_log("property id: $property_id"); ?>
